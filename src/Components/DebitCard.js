...
function DebitCard() {
  return (
    <div className="cardGroup">
      ...
      <div className="card_number">000 000 0000 0000</div>
      <div className="card_name"> Aditi Tiwari</div>
      <div className="card_from">01/23</div>
      <div className="card_to">01/27</div>
